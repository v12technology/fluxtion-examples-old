...
import com.fluxtion.fx.reconciler.casestudy1.generated.Reconciler_MIDDLE_OFFICE;
import com.fluxtion.fx.reconciler.casestudy1.generated.Reconciler_REUTERS_DC1;
  ...
  public void handleEvent(ConfigurationEvent typedEvent) {
    switch (typedEvent.filterString()) {
      case ("com.fluxtion.fx.reconciler.publishResults.config"):
        reportGenerator_REUTERS_DC1.configurePublisher(typedEvent);
        reportGenerator_EBS_LD4.configurePublisher(typedEvent);
        reportGenerator_EBS_NY2.configurePublisher(typedEvent);
        reportGenerator_FXALL_NY3.configurePublisher(typedEvent);
        reportGenerator_MIDDLE_OFFICE.configurePublisher(typedEvent);
        afterEvent();
        return;
    }
    afterEvent();
