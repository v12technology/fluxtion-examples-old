 ...
 * @author Greg Higgins
 */
public class GreaterThanDecorator_41 implements Wrapper<SoilPressure>{

    //source operand inputs
    public SoilPressureHandler filterSubject;
    public com.fluxtion.casestudy.oilsensor.generated.SoilPressureHandler source_SoilPressureHandler_40;
    ...
    public boolean onEvent(){
        ...
        result = f.isGreaterThan((double)((com.fluxtion.casestudy.oilsensor.events.SoilPressure)source_SoilPressureHandler_40.event()).value(), (double)200);
