 ...
 * @author Greg Higgins
 */
public class GreaterThanDecorator_1 implements Wrapper<WellPressure>{

    //source operand inputs
    public WellPressureHandler filterSubject;
    public com.fluxtion.casestudy.oilsensor.generated.WellPressureHandler source_WellPressureHandler_0;
    ...
    public boolean onEvent(){
        ...
        result = f.isGreaterThan((double)((com.fluxtion.casestudy.oilsensor.events.WellPressure)source_WellPressureHandler_0.event()).value(), (double)1000);
