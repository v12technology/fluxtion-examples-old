 ...
 * @author Greg Higgins
 */
public class LessThanDecorator_37 implements Wrapper<DrillTemp>{

    //source operand inputs
    public DrillTempHandler filterSubject;
    public com.fluxtion.casestudy.oilsensor.generated.DrillTempHandler source_DrillTempHandler_36;
    ...
    public boolean onEvent(){
        ...
        result = f.isLessThan((double)((com.fluxtion.casestudy.oilsensor.events.DrillTemp)source_DrillTempHandler_36.event()).value(), (double)150);
