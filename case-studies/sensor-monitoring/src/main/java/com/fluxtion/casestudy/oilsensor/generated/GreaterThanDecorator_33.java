 ...
 * @author Greg Higgins
 */
public class GreaterThanDecorator_33 implements Wrapper<DrillTemp>{

    //source operand inputs
    public DrillTempHandler filterSubject;
    public com.fluxtion.casestudy.oilsensor.generated.DrillTempHandler source_DrillTempHandler_32;
    ...
    public boolean onEvent(){
        ...
        result = f.isGreaterThan((double)((com.fluxtion.casestudy.oilsensor.events.DrillTemp)source_DrillTempHandler_32.event()).value(), (double)150);
