 ...
 * @author Greg Higgins
 */
public class LessThanDecorator_53 implements Wrapper<SoilPressure>{

    //source operand inputs
    public SoilPressureHandler filterSubject;
    public com.fluxtion.casestudy.oilsensor.generated.SoilPressureHandler source_SoilPressureHandler_52;
    ...
    public boolean onEvent(){
        ...
        result = f.isLessThan((double)((com.fluxtion.casestudy.oilsensor.events.SoilPressure)source_SoilPressureHandler_52.event()).value(), (double)560);
