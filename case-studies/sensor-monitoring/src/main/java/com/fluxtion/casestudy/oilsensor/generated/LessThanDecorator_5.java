 ...
 * @author Greg Higgins
 */
public class LessThanDecorator_5 implements Wrapper<WellPressure>{

    //source operand inputs
    public WellPressureHandler filterSubject;
    public com.fluxtion.casestudy.oilsensor.generated.WellPressureHandler source_WellPressureHandler_4;
    ...
    public boolean onEvent(){
        ...
        result = f.isLessThan((double)((com.fluxtion.casestudy.oilsensor.events.WellPressure)source_WellPressureHandler_4.event()).value(), (double)1000);
