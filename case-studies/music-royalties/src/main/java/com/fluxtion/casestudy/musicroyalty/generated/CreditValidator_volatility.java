...
import com.fluxtion.casestudy.musicroyalty.volatility.CreditRisk;
import com.fluxtion.casestudy.musicroyalty.volatility.MarketSentiment;
...
import com.fluxtion.casestudy.musicroyalty.volatility.VolatilityCalc;
...
import com.fluxtion.casestudy.musicroyalty.volatility.events.CreditRiskUpdate;
import com.fluxtion.casestudy.musicroyalty.volatility.events.InterestRateEvent;
import com.fluxtion.casestudy.musicroyalty.volatility.events.MarketTrades;
...
public class CreditValidator_volatility implements EventHandler, BatchHandler, Lifecycle {

  //Node declarations
  private final CreditRisk creditRisk_12 = new CreditRisk();
  private final MarketSentiment marketSentiment_11 = new MarketSentiment();
  ...
  private final VolatilityCalc volatilityCalc_14 =
      new VolatilityCalc(creditRisk_12, marketSentiment_11);
  private final MaxOrderSizeRule maxOrderSizeRule_5 =
      new MaxOrderSizeRule(volatilityCalc_14, userContext_1);
  ...
  public CreditValidator_volatility() {
    //node auditors
  ...
  public void handleEvent(CreditRiskUpdate typedEvent) {
    auditEvent(typedEvent);
    //Default, no filter methods
    auditInvocation(creditRisk_12, "creditRisk_12", "timePulse", typedEvent);
    creditRisk_12.timePulse(typedEvent);
    auditInvocation(volatilityCalc_14, "volatilityCalc_14", "calcVolatility", typedEvent);
    volatilityCalc_14.calcVolatility();
    auditInvocation(maxOrderSizeRule_5, "maxOrderSizeRule_5", "failedValidation", typedEvent);
    isDirty_maxOrderSizeRule_5 = maxOrderSizeRule_5.failedValidation();
    if (isDirty_maxOrderSizeRule_5) {
      creditFailReporter_9.onRuleFailure(maxOrderSizeRule_5);
  ...
  public void handleEvent(InterestRateEvent typedEvent) {
    auditEvent(typedEvent);
    //Default, no filter methods
    auditInvocation(marketSentiment_11, "marketSentiment_11", "interestRates", typedEvent);
    marketSentiment_11.interestRates(typedEvent);
    auditInvocation(volatilityCalc_14, "volatilityCalc_14", "calcVolatility", typedEvent);
    volatilityCalc_14.calcVolatility();
    auditInvocation(maxOrderSizeRule_5, "maxOrderSizeRule_5", "failedValidation", typedEvent);
    isDirty_maxOrderSizeRule_5 = maxOrderSizeRule_5.failedValidation();
  ...
  public void handleEvent(MarketTrades typedEvent) {
    auditEvent(typedEvent);
    //Default, no filter methods
    auditInvocation(marketSentiment_11, "marketSentiment_11", "trades", typedEvent);
    marketSentiment_11.trades(typedEvent);
    auditInvocation(volatilityCalc_14, "volatilityCalc_14", "calcVolatility", typedEvent);
    volatilityCalc_14.calcVolatility();
    auditInvocation(maxOrderSizeRule_5, "maxOrderSizeRule_5", "failedValidation", typedEvent);
    isDirty_maxOrderSizeRule_5 = maxOrderSizeRule_5.failedValidation();
  ...
  public void handleEvent(TimingPulseEvent typedEvent) {
    auditEvent(typedEvent);
    //Default, no filter methods
    auditInvocation(volatilityCalc_14, "volatilityCalc_14", "timePulse", typedEvent);
    volatilityCalc_14.timePulse(typedEvent);
    auditInvocation(volatilityCalc_14, "volatilityCalc_14", "calcVolatility", typedEvent);
    volatilityCalc_14.calcVolatility();
    auditInvocation(maxOrderSizeRule_5, "maxOrderSizeRule_5", "failedValidation", typedEvent);
    isDirty_maxOrderSizeRule_5 = maxOrderSizeRule_5.failedValidation();
  ...
  private void initialiseAuditor(Auditor auditor) {
    auditor.init();
    auditor.nodeRegistered(creditRisk_12, "creditRisk_12");
    auditor.nodeRegistered(marketSentiment_11, "marketSentiment_11");
    ...
    auditor.nodeRegistered(volatilityCalc_14, "volatilityCalc_14");
