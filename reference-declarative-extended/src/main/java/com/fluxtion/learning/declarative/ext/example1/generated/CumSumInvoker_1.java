...
public class CumSumInvoker_1 implements NumericValue{
    ...
    public DataEventHandlerStringFilter[] sourceUpdated_DataEventHandlerStringFilter_0 = new DataEventHandlerStringFilter[4];
    private final CumSum f = new CumSum();
    private double result;
    private double newValue;
    private boolean updated;

    @OnParentUpdate("sourceUpdated_DataEventHandlerStringFilter_0")
    public void sourceUpdated_DataEventHandlerStringFilter_0(DataEventHandlerStringFilter updated){
