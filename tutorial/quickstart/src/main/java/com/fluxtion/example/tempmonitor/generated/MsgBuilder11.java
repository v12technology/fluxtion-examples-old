...
public class MsgBuilder11 extends MsgBuilder{
    ...
    @NoEventReference
    public com.fluxtion.example.tempmonitor.generated.TempEventHandler source_TempEventHandler_10;
    ...
    public boolean buildMessage() {
        if(notificationToLog & isGoodToLog()){
            msgSink.append("Temp ");
            msgSink.append(((com.fluxtion.example.tempmonitor.TempHandler.TempEvent)source_TempEventHandler_10.event()).getTemp());
