 ...
 * @author Greg Higgins
 */
public class MsgBuilder17 extends MsgBuilder{

    //source operand inputs
    @NoEventReference
    public com.fluxtion.example.tempmonitor.generated.TempEventHandler source_TempEventHandler_16;
    ...
    public boolean buildMessage() {
        if(notificationToLog & isGoodToLog()){
            msgSink.append("Temp ");
            msgSink.append(((com.fluxtion.example.tempmonitor.TempHandler.TempEvent)source_TempEventHandler_16.event()).temp());
