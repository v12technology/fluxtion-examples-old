 ...
 * @author Greg Higgins
 */
public class GreaterThanDecorator_7 implements Test{

    //source operand inputs
    public com.fluxtion.example.tempmonitor.generated.TempEventHandler source_TempEventHandler_6;
    ...
    public boolean onEvent(){
        ...
        result = f.isGreaterThan((double)((com.fluxtion.example.tempmonitor.TempHandler.TempEvent)source_TempEventHandler_6.event()).temp(), (double)25);
